        ...
        <div class="section-body">
            ...
            <div class="card">
                <div class="card-header">
                    <h4><i class="fas fa-exam"></i>ASSESMENT</h4>
                </div>
                ...
                <div class="card-body">
                    ...
                    @hasanyrole('petugas1|petugas2|petugas3|petugas4|petugas5|petugas6|petugas7|direktur|karyawan|admin')
                        <div class="form-group">
                            <div class="input-group mb-3">
                                @can('asess.create')
                                    <div class="input-group-prepend">
                                        <a href="{{ route('asess.create') }}" class="btn btn-primary" style="padding-top: 10px;"><i class="fa fa-plus-circle"></i> TAMBAH</a>
                                    </div>
                                @endcan
                                <input type="text" class="form-control" name="q"
                                       placeholder="cari berdasarkan tanggal asess">
                            ...
                            @can('asess.export_as')
                                <a href="{{ route('asess.export_as') }}" class="btn btn-sm btn-primary"> Laporan Bulanan
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        @can('asess.edit')
                                            <a href="{{ route('asess.edit', $asess->id) }}" class="btn btn-sm btn-primary">
                                                <i class="fa fa-pencil-alt"></i>
                                            </a>
                                        @endcan

                                        @can('asess.delete')
                                            <button onClick="Delete(this.id)" class="btn btn-sm btn-danger" id="{{ $asess->id }}">

                        ...
                        <div class="form-group">
                            ...
                            <select id="monthSelector" name="bulan" class="form-control" onchange="updateDates()" required>
                                @foreach (['Januari', 'Februari', 'Maret', 'April', 'Mei', 'Juni', 'Juli', 'Agustus', 'September', 'Oktober', 'November', 'Desember'] as $index => $month)
                                    <option value="{{ $index + 1 }}" {{ $monitorings->bulan == ($index + 1) ? 'selected' : '' }}>{{ $month }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        <td rowspan="6">
                                            <input type="text" name="variabel" value="{{ $monitorings->variabel }}" required>
                                        </td>
                                        <td rowspan="3">
                                            <input type="text" name="sub_variabel_1" value="{{ $monitorings->sub_variabel_1 }}" required>
                                        </td>
                                        <td id="datesColumn1" class="d-flex justify-content-start">
                                            <tr></tr>
                                        </td>
                                        <td></td>
                                        <td><input type="number" name="total_1" id="total_1" value="{{ $monitorings->total_1 }}" readonly></td>
                                    </tr>
                                    <tr>
                                        <td rowspan="3">
                                            <input type="text" name="sub_variabel_2" value="{{ $monitorings->sub_variabel_2 }}" required>
                                        </td>
                                        <td id="datesColumn2" class="d-flex justify-content-start">
                                            <tr></tr>
                                        </td>
                                        <td></td>
                                        <td><input type="number" name="total_2" id="total_2" value="{{ $monitorings->total_2 }}" readonly></td>
                                        <td>
                                            <div style="position: relative;">
                                                <input type="number" name="hasil" id="hasil" value="{{ $monitorings->hasil }}" readonly style="padding-right: 30px;">

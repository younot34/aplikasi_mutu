...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>RAWAT INAP - Kepatuhan pengisian EWS</h1>
        </div>

        <div class="section-body">
            <div class="card">
                <div class="card-header">
                    <h4><i class="fas fa-chart-line"></i>Grafik Kepatuhan pengisian EWS </h4>
                </div>

                <div class="card-body">
                    <form action="{{ route('ewss.grafik_e') }}" method="GET" class="d-inline-block">
                    ...
                    <div class="mt-4">
                        <canvas id="ewsChart" style="height: 400px; width: 100%;"></canvas>
                    </div>

                    <!-- Menampilkan total obat formularium nasional dan total item -->
                    <div class="mt-4">
                        <h5>Total Kepatuhan pengisian EWS per Bulan</h5>
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    <th>Bulan</th>
                                    <th>Total Ews Terisi</th>
                                    <th>Total Ews Tidak Terisi</th>
                                </tr>
                            </thead>
                            <tbody>

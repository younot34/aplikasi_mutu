                    ...
                    <form action="{{ route('farmasis.update', $farmasi->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-3">
                                ...
                                <input type="number" name="total_obat_fornas[]" value="{{ $obat->total_obat_fornas }}" class="form-control" id="total_obat_fornas">
                            </div>
                            <div class="form-group col-md-3">
                                <label>Total Item</label>
                                <input type="number" name="total_item[]" value="{{ $obat->total_item }}" class="form-control" id="total_item">
                            </div>
                        </div>
                        @endforeach
                        ...
                        <div id="obat-container">
                            @foreach ($farmasi->nama_obats as $index => $nama_obatss)
                                <div class="form-row" id="obat-row-{{ $index }}">
                                    <div class="form-group col-md-3 ">
                                        <label>R/</label>
                                        <input type="number" name="r[]" value="{{ $nama_obatss->r }}" class="form-control">
                                        @error('no_rm')
                                        <div class="invalid-feedback" style="display: block">
                                            {{ $message }}
                                        </div>
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" name="nama_obat[]" value="{{ $nama_obatss->nama_obat }}" class="form-control" list="obat_list" onchange="updateTotals()">
